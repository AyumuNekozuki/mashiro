...
export default {
	...
	reminder: {
		...
		notify: (name) => name ? `${name}、これやりました...？` : `これの進捗、どうでしょう...？`,

		notifyWithThing: (thing, name) => name ? `${name}、「${thing}」やりました...？` : `「${thing}」やりましたか...？`,
	 ...
	 */
	valentine: {
		chocolateForYou: name => name ? `${name}、その... チョコレート作ったので...どうぞっ！🍫` : 'チョコレート作ったのでよかったらどうぞ！🍫',
	},
	...
	timeSignal: {
		'text': '日付変わったよ...？そろそろ寝なくてだいじょうぶ...？',
		'newYear': 'あけましておめでとうございます！今年もよろしくお願いします...！',
	},
